                        ...
                        <div className="flex flex-col lg:w-2/3">
                            ...
                            <div className='container mx-auto mt-10'>
                                ...
                                <div className="grid gap-4 mt-6">
                                    {/* Repeating FAQ Items */}
                                    <div className="relative w-full max-w-full h-auto bg-white rounded-2xl border border-gray-300 p-3">
                                        <div className="text-gray-900 text-sm sm:text-base font-semibold">Etiam rhoncus nibh at tellus hendrerit ac convallis?</div>
                                        <span>
                                            <i className='absolute bi bi-chevron-down top-3 right-5'></i>
                                        </span>
                                    </div>
                                    <div className="relative w-full max-w-full h-auto bg-white rounded-2xl border border-gray-300 p-3">
                                        <div className="text-gray-900 text-sm sm:text-base font-semibold">Etiam rhoncus nibh at tellus hendrerit ac convallis?</div>
